...
Cardano components compatibility matrix shows run-time Cardano component dependency on a particular version of [cardano-node](https://github.com/input-output-hk/cardano-node/releases). It does not reflect any stacks. The compatibility matrix should be read in conjunction with [Cardano component dependencies](comp_dependencies.jpg) definition.
